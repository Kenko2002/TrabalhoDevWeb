...
public class AppHistoriaDeUsuario {
	...
	public ArrayList<HistoriaDeUsuario> getAll(){
		...
		IArvoreBinaria<HistoriaDeUsuario> arvoreHistorias = new ArvoreAVL<>(new ComparatorEpicoID());
		...
		return (ArrayList<HistoriaDeUsuario>) arvoreHistorias.caminharEmOrdemLista();
